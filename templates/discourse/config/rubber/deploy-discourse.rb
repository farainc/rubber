namespace :rubber do
  ...
  namespace :discourse do
    ...
    task :create_postgres_extensions, :roles => :postgresql_master do
      rsudo "export DEBIAN_FRONTEND=noninteractive; apt-get -q -o Dpkg::Options::=--force-confold -o APT::Get::allow-downgrades=true -o APT::Get::allow-change-held-packages=true -y install postgresql-contrib"
